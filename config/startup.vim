...
" After opening Vim wait for 10 ms and open old files
function! StartupPage()
  call timer_start(0, {-> execute("if &filetype == 'fyler_finder' | execute 'BNext' | execute 'OldFilesProject' | endif")})
endfunction
autocmd VimEnter * call StartupPage()
